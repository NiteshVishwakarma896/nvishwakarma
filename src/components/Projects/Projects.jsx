...
export default function Projects() {
  return (
        <div id='projects' class="relative z-20 h-full flex items-center justify-center overflow-hidden">
            ...
            <div class="container relative items-center block sm:flex px-6 md:px-6 lg:px-10 xl:px-40 py-16 mx-auto">
                <div class="relative z-20 flex flex-col ">
                    <h1 class="flex flex-col text-3xl leading-none text-gray-800 sm:text-4xl dark:text-white mb-2">Projects</h1>
                    <span class="w-28 sm:w-36 h-2 mb-4 bg-gray-800 dark:bg-white">
                    </span>
