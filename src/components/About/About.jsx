...
export default function About() {
  return (
        <div id='about' class="relative z-20 h-screen flex items-center justify-center overflow-hidden">
            <div class="container relative items-center justify-center block sm:flex px-6 md:px-6 lg:px-10 xl:px-40  mx-auto">
                <div class="relative z-20 flex flex-col ">
                    <h1 class="flex flex-col text-3xl leading-none text-gray-800 sm:text-4xl dark:text-white mb-2">About </h1>
                    <span class="w-28 h-2 mb-4 bg-gray-800 dark:bg-white">
                    </span>
                   
                    <p class="text-sm text-gray-700 sm:text-lg dark:text-white mt-4 font-extralight">
                    ...
                    <div className="flex-col mt-6 sm:w-1/2">
                        <div className='mb-6'>
                            <h1 class="flex flex-col text-md leading-none mb-4 text-gray-800  font-bebas-neue sm:text-md dark:text-white">Programming Languages</h1>
                        ...
                        <div className='mb-6'>
                            <h1 class="flex flex-col text-md leading-none mb-4 text-gray-800  font-bebas-neue sm:text-md dark:text-white">Web Technologies</h1>
                        ...
                        <div className='mb-6'>
                            <h1 class="flex flex-col text-md leading-none mb-4 text-gray-800  font-bebas-neue sm:text-md dark:text-white">Database and Platform Tools</h1>
                            <div className="flex flex-wrap  sm:flex-nowrap gap-4">
