        ...
        <div className="relative z-20 h-fit flex items-center justify-center overflow-hidden">
            ...
            <div className="container relative items-center justify-center block sm:flex px-6 md:px-6 lg:px-10 xl:px-40 py-10 sm:py-24 mx-auto">
                <div className="relative z-20 flex flex-col sm:w-2/3 lg:w-1/2">
                    ...
                    <p style={{lineHeight:'24px'}} className="text-sm text-gray-700 sm:text-base dark:text-white mt-4 font-extralight">
                        <span className="text-2xl sm:text-3xl font-normal">Hola😎</span>, I am <b>Nitesh Vishwakarma</b> an Experienced Software Engineer skilled in designing software solutions, Known for complex technical design and enhancing system performance and availability.
                    </p>
                ...
                <div className="relative mt-4 md:mt-0 sm:block sm:w-1/3 lg:w-1/2">
                    <img src={NonBgProfile} className="max-w-xs m-auto md:max-w-xl"/>
                </div>
            </div>
        </div>
